    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">CarPool</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cookies" className="text-sm hover:text-gray-300">
                  Cookie Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex items-center justify-between">
          <p className="text-sm text-gray-300">
            &copy; {new Date().getFullYear()} CarPool. All rights reserved.
          </p>
          <p className="text-sm text-gray-300">
